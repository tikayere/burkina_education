...
"""Whitelisted API for the Vue Academic Portal, shared by three roles whose
...
- Academic Director: both of the above, plus Curriculum, Competency,
  Learning Objective/Unit, Lesson, Grading Scheme, Assessment Type,
  Disciplinary Case, Scholarship, School, Announcement, Student Term/Annual
  Report, and Burkina Education Settings.
...
custom endpoint, and shapes its response to whichever of the three roles the
...
ACADEMIC_ROLES = ("Registrar", "Academic Director", "Examination Coordinator")
...
def get_dashboard():
	...
	out = {"is_director": is_director, "has_structure": has_structure, "has_exams": has_exams}
